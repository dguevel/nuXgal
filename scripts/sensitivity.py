...
def main():
    ...
    parser.add_argument('-ebinmin', '--ebinmin', help='Minimum energy bin', type=int)
    parser.add_argument('-ebinmax', '--ebinmax', help='Maximum energy bin', type=int)

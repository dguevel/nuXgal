...
SYNTHETIC_EVTMAP_FORMAT = os.path.join(NUXGAL_SYNTHETICDATA_DIR, 'skymaps', 'eventmap_astro_{i}.fits')
...
SYNTHETIC_W_MEAN_FORMAT = os.path.join(NUXGAL_SYNTHETICDATA_DIR, 'w_mean_{galaxyName}_{nyear}.txt')
